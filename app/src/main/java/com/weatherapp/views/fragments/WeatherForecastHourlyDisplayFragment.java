...
import com.weatherapp.adapters.WeatherForecastHourlyDataAdapter;
...
public class WeatherForecastHourlyDisplayFragment extends android.support.v4.app.Fragment {
    private RecyclerView mRecyclerView;
    private RecyclerView.LayoutManager mLayoutManager;
    private WeatherForecastHourlyDataAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.weather_forecast_hourly_display, container, false);
    ...
    private void setDataInViews() {
        if (weatherData.getHourly() != null) {
            ...
            int resourceId = TextToImageUtil.getImageDrawable(weatherData.getHourly().getSummary().toLowerCase());
            img_weather_type.setBackgroundResource(resourceId);

            ArrayList<DataHourly> data = weatherData.getHourly().getData();
            tv_summary.setText(weatherData.getHourly().getSummary());
            mAdapter = new WeatherForecastHourlyDataAdapter(data);
