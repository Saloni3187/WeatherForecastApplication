...
import com.weatherapp.model.DataHourly;
 ...
 */
public class WeatherForecastHourlyDataAdapter extends RecyclerView
        .Adapter<WeatherForecastHourlyDataAdapter
        .DataObjectHolder> {
    private ArrayList<DataHourly> mDataset;
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        public DataObjectHolder(View itemView) {
            ...
            tv_temp=(TextView) itemView.findViewById(R.id.tv_temprature);
            tv_app_temp=(TextView) itemView.findViewById(R.id.tv_appreantTemp);
    ...
    public WeatherForecastHourlyDataAdapter(ArrayList<DataHourly> myDataset) {
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.weather_forecast_hourly_data_display, parent, false);
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        ...
        holder.tv_temp.setText(mDataset.get(position).getTemperature()+"");
        holder.tv_app_temp.setText(mDataset.get(position).getApparentTemperature()+"");
